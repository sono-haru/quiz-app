                ...
                <div className="flex flex-col items-center">
                    <button type="submit" className="w-[150px] block mt-[40px]">
                        <img
                            ...
                            alt="ログインボタン"
                            className="w-[150px] rounded-lg border-2 border-white transition-all duration-200 ease-in active:scale-[0.98] drop-shadow-lg"
                        />
                    </button>
                    ...
                    <div className="flex items-center justify-center rounded-lg border-2 border-white bg-[#D9D9D9] opacity-[0.8] w-[185px] h-[35px] mt-[30px]">
                        <Link href="/signup">
                            <p className="text-center text-[15px] drop-shadow-lg">登録がまだの方はこちら</p>
                        </Link>
                    </div>
                </div>
            </form>
